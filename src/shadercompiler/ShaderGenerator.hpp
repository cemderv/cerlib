...
{
  public:
    using ParameterList = small_vector_of_refs<const ShaderParamDecl, 8>;
...
class ShaderGenerator
{
  ...
  protected:
    ...
    small_vector<const FunctionDecl*, 8>         m_call_stack;
    small_vector<TempVarNameGen, 4>              m_temp_var_name_gen_stack;
